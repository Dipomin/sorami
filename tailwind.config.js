...
module.exports = {
  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        ...
        'gradient-dark': 'linear-gradient(to bottom right, #0f172a, #1e1b4b, #312e81)',
  ...
  plugins: [
    // @tailwindcss/line-clamp is now built-in since Tailwind CSS v3.3
  ],
}