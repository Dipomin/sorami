...
export default function BlogEditorPage() {
  ...
  const [currentTab, setCurrentTab] = useState<'content' | 'settings' | 'seo'>('content');
    ...
    const fetchPost = async () => {
      ...
      try {
        ...
        setFormData({
          ...
          publishedAt: post.publishedAt ? new Date(post.publishedAt).toISOString().slice(0, 16) : undefined,
      ...
      <div className="flex justify-between items-center mb-8">
        <div>
          ...
          <p className="text-slate-400">
            {postId ? 'Mettez à jour votre article' : 'Créez un nouvel article de blog'}
          </p>
        </div>
        ...
        >
          ...
          <div className="bg-slate-900/50 backdrop-blur-sm rounded-lg p-6">
            ...
            <p className="text-sm text-slate-500 mt-2">
              Utilisez Markdown pour formater votre contenu. Prévisualisation en temps réel.
            </p>
          </div>
        </motion.div>
      )}
          ...
          <div className="bg-slate-900/50 backdrop-blur-sm rounded-lg p-6">
            ...
            <div className="bg-white p-4 rounded-lg">
              ...
              <div className="text-green-700 text-sm mb-2">
                https://sorami.app/blog/{formData.title ? formData.title.toLowerCase().replace(/\s+/g, '-') : 'article'}
              </div>
              <div className="text-gray-600 text-sm">
                {formData.metaDescription || formData.excerpt || 'Description de votre article...'}
              </div>
            </div>
          </div>
        </motion.div>
