            ...
            <ReactMarkdown
              components={{
                ...
                code: ({ node, inline, ...props }: any) =>
                  inline ? (
                    <code
                      className="bg-slate-800 text-violet-400 px-2 py-1 rounded"
                      {...props}
                    />
                  ) : (
                    <code
                      className="block bg-slate-800 text-slate-300 p-4 rounded-lg overflow-x-auto mb-4"
                      {...props}
                    />
                  ),
                blockquote: ({ node, ...props }) => (
                  <blockquote
                    className="border-l-4 border-violet-600 pl-4 py-2 italic text-slate-400 my-6"
                    {...props}
                  />
                ),
              }}
